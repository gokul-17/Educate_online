...
<?php 
  ...
  {  
	...
	$up=$_FILES["img"]["name"];
    	...
    	$typ=$_FILES["img"]["type"];
	$sql=mysqli_query($con,"insert into posts(usr_id_p,status_title,status,upload,status_time) 
...
<body>
 ...
 <div id="navbar" class="navbar-collapse collapse">
    ...
    <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">Educate-Online Learning </label>
    <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium ">Hi! <font style="font-size:13px"> <?php echo $_SESSION["name"]; ?></font> </label>
...
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
            ...
            <!-- content goes here -->
              ...
              <div class="form-group">
                ...
                <textarea   name="status_title" class="form-control" placeholder="eg:Assignments"></textarea>
		...
		<div class="form-group">
                  <label for="exampleInputupload">Upload Document</label>
 ...
 <!--
 <li>
 <a href="notification.php"><span  class="glyphicon glyphicon-comment"  aria-hidden="true"></span> <font style="color:white"> Notification </font></a>
 </li> 
 ...
 $("#menu-toggle").click(function(e) {
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.photos').click(function() { $('.arrow').css("left", 130);});
		});
	</script>
