...
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
		...
		<div class="modal-body">
            ...
            <!-- content goes here -->
              ...
              <div class="form-group">
                ...
                <textarea   name="status_title" class="form-control" placeholder="eg:Assignment"></textarea>
 ...
 <!--
 <li>
 <a href="notification.php"><span  class="glyphicon glyphicon-comment"  aria-hidden="true"></span> Notification</a>
 </li> 
