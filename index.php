...
<div class="container">
	<div class="sixteen columns">
		...
		<div id="logo" style="margin-top:15px">
			<h1><a href="index.php"><font style="font-size:25px; color:white">Educate-OnlineLearning</font></a></h1>
		</div>
...
<!-- Banner
================================================== -->
<div id="banner" class="with-transparent-header parallax background" style="background-image: url(images/banner-home-02.jpg)" data-img-width="1280" data-img-height="640" data-diff="100">
	<div class="container">
		<div class="sixteen columns">
			...
			<div class="search-container">
				...
				<!-- Announce -->
				<div class="announce">
					<strong>Better Way to Learn</strong> 
				</div>
...
<div class = "modal fade" id = "signupModal" tabindex = "-1" role = "dialog" 
   ...
   <div class = "modal-dialog">
      <div class = "modal-content">
         ...
         <div class = "modal-body">
            Select Your Photo: <input type="file" name="img" />
         </div>
...
<div class="container">
	<!-- Recent -->
	<h1 class="text-center">New Assignments</h1>
	...
	<div class="five columns">
		...
		<div class="widget">
			...
			<img src="images/educate1.jpg" height="100px" width="100px"/>
		...
		<div class="widget">
			...
			<ul class="checkboxes">
				<li>
					<img src="images/educate2.jpg" height="100px" width="100px"/>
